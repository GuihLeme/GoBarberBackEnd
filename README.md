...
- O usuário deve poder listar os dias de um mês com pelo menos com horário disponível de um prestador;
...
- Os agendamentos devem estar disponíveis entre 8h às 18h (Primeiro horário iniciando às 8h e o último às 17h);
